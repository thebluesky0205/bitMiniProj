...
// 그러므로 현재 에제를 토대로 유사한 연습문제를 작성해보자!...
// .1 MySQL에 table을 작성한다.
// (Entity: ItemMania
// id, pw, nickname, item. price
// 2. entity 패키지에 실제 사용할 Entity클래스를 작성한다.
// 3. controller 패키지에 URl을 처리할 ItemMainController를 만든다.
...
// 7-4. rea(게시글을 실제로 읽을 수 있도록 만들어본다.)
